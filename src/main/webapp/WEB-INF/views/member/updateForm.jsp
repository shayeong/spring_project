...
<h3>정보 수정 <small>(<span id="need">*</span> 필수입력사항)</small></h3>
  <form 
    ...
    <div class="form-control">${dto.id}</div>
     </div>
 
    <div class="input-group mb-3">
    <div class="input-group-text">이름</div>
      <div class="form-control">${dto.mname}</div>
    </div>
    ...
    <div class="input-group mb-3">
     ...
     <div class="input-group mb-3">
    <div class="input-group-text"><span id="need">* </span> 직업 </div>
